  ...
  return (
    ...
    >
      ...
      <View style={styles.layout}>
        <View style={{ ...styles.container, ...styles.container_top }}>
          {pm.bookingsList && pm.bookingsList.length > 0 && (
            <>
              <Text style={styles.court_data}>
                {pm.bookingsList[0].courtName}
              </Text>
              <Text style={styles.court_data}>
                {pm.bookingsList[0].courtLocation}
              </Text>
              <Text style={styles.court_data}>
                {pm.bookingsList[0].date}, {pm.bookingsList[0].time}
              </Text>
              <View style={styles.options}>
                <Text
                  style={
                    pm.bookingsList[0].isCompleted
                      ? styles.complete
                      : styles.cancelled
                  }
                >
        ...
        <View style={{ ...styles.container, ...styles.container_next }}>
          {pm.bookingsList && pm.bookingsList.length > 0 && (
            <>
              <Text style={styles.court_data}>
                {pm.bookingsList[0].courtName}
        ...
        <View style={{ ...styles.container, ...styles.container_third }}>
          {pm.bookingsList && pm.bookingsList.length > 0 && (
            <>
              <Text style={styles.court_data}>
                {pm.bookingsList[0].courtName}
        ...
        <View style={{ ...styles.container, ...styles.container_forth }}>
          {pm.bookingsList && pm.bookingsList.length > 0 && (
            <>
              <Text style={styles.court_data}>
                {pm.bookingsList[0].courtName}
